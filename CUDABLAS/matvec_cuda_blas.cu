// nvcc matvec_cuda_blas.c -lcublas -o matvec blas
#include  <stdio.h>
#include  <stdlib.h>
#include  <math.h>
...
#define m 32768                                  //  number  of rows of a
#define n 32768                              //  number  of  columns  of a
...
int  main(void){
	...
	for(j=0;j<n;j++){                              // 11,17,23,29,35
	   ...
	   cudaStat=cudaMalloc ((void **)&d_a ,m*n*sizeof (*a)); //  device//  memory  alloc  for a
	   cudaStat=cudaMalloc ((void **)&d_x ,n*sizeof (*x));    //  device//  memory  alloc  for x
	   cudaStat=cudaMalloc ((void **)&d_y ,m*sizeof (*y));    //  device//  memory  alloc  for y
